...
In this tutorial we will look at mutual exclusion and briefly at failure detectors. Both of these topics much more to offer. In particular, we will only examine mutual exclusion under message passing and won't look at shared register algorithms.

If you're interested to learn more broadly on these topics, a great place to start is Lamport's bakery algorithm and if interested further continue onto queue, CLH and MCS locks.
